...
export const translations = {
  sk: {
    ...
    'settings.address_info': 'Adresa trvalého bydliska',
    'settings.street': 'Ulica a číslo domu',
    'settings.city': 'Mesto',
    ...
    'settings.notif_toggle': 'Zapnúť upozornenia',
  ...
  en: {
    ...
    'settings.address_info': 'Address Information',
    'settings.street': 'Street & Number',
    'settings.city': 'City',
